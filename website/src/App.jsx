          ...
          <div className="container" style={{ textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: '2rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <div className="glass-panel" style={{ flex: '1', minWidth: '300px', maxWidth: '400px' }}>
                ...
                <a href="/downloads/KinetixSetup.exe" download className="btn-neon" style={{ width: '100%', justifyContent: 'center' }}>Download .EXE</a>
              </div>
              ...
              <div className="glass-panel" style={{ flex: '1', minWidth: '300px', maxWidth: '400px' }}>
                ...
                <a href="/downloads/kinetix.apk" download className="btn-outline" style={{ width: '100%', justifyContent: 'center' }}>Download .APK</a>
              </div>
